...
/*
 *     col: { B11, B10, B2, B1, A7, B0, B4, A6, A3, B3}
...
uint8_t matrix_scan(void) {
    ...
    for (int col = 0; col < MATRIX_COLS; col++) {
        ...
        // strobe col { B11, B10, B2, B1, A7, B0, B4, A6, A3, B3 }
        switch (col) {
			...
			case 8: palSetPad(GPIOA, 3); break;
        ...
        // unstrobe col { B11, B10, B2, B1, A7, B0, B4, A6, A3, B3 }
        switch (col) {
			...
			case 8: palClearPad(GPIOA, 3); break;
